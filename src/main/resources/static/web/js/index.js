    ...
    methods: {
        signIn: function (event) {
            ...
            axios.post('/api/login', `email=${this.email}&password=${this.password}`, config)
                .then(response => window.location.href = "/web/profile.html")
                .catch(() => {
        ...
        signUp: function (event) {
            ...
            axios.post('/api/professionals', `firstName=${this.firstName}&lastName=${this.lastName}&email=${this.email}&password=${this.password}`, config)
